...
//   oci-rust-sdk/crates/common/src/region_definitions.rs.
...
lazy_static! {
    pub static ref REGIONS_SHORT_NAMES: HashMap<&'static str, &'static str> = HashMap::from([
        ("yny", "ap-chuncheon-1"),
        ("hyd", "ap-hyderabad-1"),
        ("mel", "ap-melbourne-1"),
        ("bom", "ap-mumbai-1"),
    ...
    pub static ref REGION_REALMS: HashMap<&'static str, &'static str> = HashMap::from([
        ("ap-chuncheon-1", "oc1"),
        ("ap-hyderabad-1", "oc1"),
        ("ap-melbourne-1", "oc1"),
        ("ap-mumbai-1", "oc1"),
    ...
    pub static ref REALMS: HashMap<&'static str, &'static str> = HashMap::from([
        ("oc1", "oraclecloud.com"),
    ...
    pub static ref REGIONS: HashSet<&'static str> = HashSet::from([
        "ap-chuncheon-1",
        "ap-hyderabad-1",
        "ap-melbourne-1",
        "ap-mumbai-1",
