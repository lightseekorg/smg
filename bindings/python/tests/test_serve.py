...
class TestSglangWorkerLauncher:
    ...
    def test_build_command_http_mode_with_token_usage_details(self):
        """When connection_mode is http and enable_token_usage_details is True, --enable-cache-report should be present."""
        launcher = SglangWorkerLauncher()
...
class TestVllmWorkerLauncher:
    ...
    def test_build_command_http_mode_with_token_usage_details(self):
        """When connection_mode is http and enable_token_usage_details is True, --enable-prompt-tokens-details should be present."""
        launcher = VllmWorkerLauncher()
        args = argparse.Namespace(
