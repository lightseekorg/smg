...
class TestToolUseBasic:
    ...
    def test_single_tool_call(self, setup_backend):
    ...
    def test_tool_call_and_result_round_trip(self, setup_backend):
    ...
    def test_tool_use_streaming(self, setup_backend):
    ...
    def test_multiple_tools_available(self, setup_backend):
