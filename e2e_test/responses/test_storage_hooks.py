...
class TestResponsesWithStorageHook:
    ...
    def test_create_and_get_response_with_hook(self, setup_backend):
    ...
    def test_conversation_with_previous_response_with_hook(self, setup_backend):
    ...
    def test_input_items_list_with_hook(self, setup_backend):
