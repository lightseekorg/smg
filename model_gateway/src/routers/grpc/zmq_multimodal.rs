...
mod tests {
    ...
    fn batched_keys_split_per_row_and_cast_to_model_dtype() {
        let features = build_mm_features(base_inputs(), &[], ModelDtype::BFloat16).expect("built");
    ...
    fn flat_keys_slice_by_cumulative_sizes() {
        ...
        let features = build_mm_features(mm, &[], ModelDtype::Float32).expect("built");
    ...
    fn unlisted_keys_are_shared_and_replicated() {
        ...
        let features = build_mm_features(mm, &[], ModelDtype::BFloat16).expect("built");
